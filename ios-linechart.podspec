Pod::Spec.new do |s|
  ...
  s.source       = { :git => "https://github.com/mruegenberg/ios-linechart.git", :tag => "1.1.0" }

  s.platform     = :ios, '5.0'

  s.source_files = 'ios-linechart/LCLegendView.{h,m}', 'ios-linechart/LCLineChartView.{h,m}', 'ios-linechart/LCInfoView.{h,m}'
